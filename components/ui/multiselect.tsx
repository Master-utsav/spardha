      ...
      >
        <div className="flex flex-wrap gap-1">
          {selected.map((option) => {
            return (
              ...
              >
                {option.label}
                <button
                  className="size-7 outline-hidden absolute -inset-y-px -end-px flex items-center justify-center rounded-e-md border border-transparent p-0 text-muted-foreground/80 outline-none transition-[color,box-shadow] hover:text-foreground focus-visible:border-ring focus-visible:ring-[3px] focus-visible:ring-ring/50"
                  onKeyDown={(e) => {
                    if (e.key === 'Enter') {
          ...
          <CommandPrimitive.Input
            ...
            className={cn(
              'outline-hidden flex-1 bg-transparent placeholder:text-muted-foreground/70 disabled:cursor-not-allowed',
              {
          ...
          <button
            ...
            className={cn(
              'size-9 absolute end-0 top-0 flex items-center justify-center rounded-md border border-transparent text-muted-foreground/80 outline-none transition-[color,box-shadow] hover:text-foreground focus-visible:border-ring focus-visible:ring-[3px] focus-visible:ring-ring/50',
              (hideClearAllButton ||
                disabled ||
                selected.length < 1 ||
